...
int main(void)
{
    ...
    RUN_TEST(test_flock_ssid_patterns_are_notable_for_badge);
    ...
    RUN_TEST(test_badge_flock_field_oui_and_wildcard_probe_produce_flock_camera);
    ...
    RUN_TEST(test_transport_prefers_usb_when_ready);
    RUN_TEST(test_transport_falls_back_to_uart_when_usb_unavailable);
    RUN_TEST(test_transport_switches_to_usb_after_reconnect);
    RUN_TEST(test_transport_error_counters_and_heartbeat);
    RUN_TEST(test_scanner_online_offline_over_usb);
    RUN_TEST(test_uplink_restart_with_scanner_attached);
    RUN_TEST(test_usb_replug_reconnect_behavior);
    RUN_TEST(test_uart_fallback_when_usb_path_unavailable);
    RUN_TEST(test_usb_bridge_parse_defaults_to_ble_without_slot);
    RUN_TEST(test_usb_bridge_parse_wifi_slot_name_maps_to_wifi);
    RUN_TEST(test_usb_bridge_parse_numeric_slot_one_maps_to_wifi);
    RUN_TEST(test_usb_bridge_parse_ble_slot_name_maps_to_ble);
    RUN_TEST(test_usb_bridge_parse_rejects_unknown_slot);
    RUN_TEST(test_usb_bridge_parse_rejects_empty_slot);
    RUN_TEST(test_usb_bridge_parse_rejects_empty_json_after_slot);
